...
function AdministratorRightbar(props) {
  ...
  return (
    <div className={styles.StudentRight}>
      ...
      <section className={styles.ActionImports}>
        <p>Add Admin</p>
        <span onClick={AddAdmin}>
          <IoAdd></IoAdd>
        </span>
      </section>
      <br></br>
      <section className={styles.ActionImports} ref={exportCont}>
        <p>Export</p>
...
export default withRouter(AdministratorRightbar);
